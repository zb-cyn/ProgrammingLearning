<template>
    <div class="app-container">
        ...
        <el-dialog :title="formData.Id ? '修改试卷明细' : '添加试卷明细'" :visible.sync="editorShow" width="50%" :lock-scroll="true"
            height="800px">
                ...
                <el-row :gutter="10" class="EditFromBody">
                    ...
                    <el-col :span="24">
                        <el-form-item label="分数" prop="Score">
                            <el-input type="number" v-model.trim="formData.Score" placeholder="请输入分数"
                                :clearable="true"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
        ...
        <PaginationTable ref="PaginationTableId" url="/QuestionnaireDet/List" :column="dataColum" :where="where">
...
export default {
    ...
    methods: {
        ...
        async UpdateEntityAsync(Id, title, data) {
            let { Data } = await this.$PostSigleUpdate(`/QuestionnaireDet/Get`, `/QuestionnaireDet/CreateOrEdit`, Id, title, data);
        ...
        async ShowEditModal(Id) {
            ...
            let { Data } = await this.$Post(`/QuestionnaireDet/Get`, { Id: Id });
            this.formData = Data;
        ...
        async CreateOrEditForm() {
            ...
            this.$refs.editModalForm.validate(async valid => {
                if (valid) {
                    var { Success } = await this.$Post(`/QuestionnaireDet/CreateOrEdit`, this.formData);
        ...
        async ShowDeleteModal(Id) {
            await this.$PostDelete(`/QuestionnaireDet/Delete`, { Id: Id });
            this.$refs.PaginationTableId.Reload(this.searchForm);
        },
        /**
         * 批量删除的时候会触发
        ...
        async ShowBatchDeleteModal() {
            ...
            await this.$PostDelete(`/QuestionnaireDet/BatchDelete`, { Ids: ids });
