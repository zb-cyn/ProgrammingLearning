    ...
    <div class="register-container">
        ...
        <div class="register-left">
            ...
            <div class="left-content">
                ...
                <div class="platform-desc">
                    <h3>开启您的编程之旅</h3>
                    <ul>
                        <li>海量优质编程课程，涵盖多种主流编程语言</li>
                        <li>实战项目驱动学习，快速提升编程能力</li>
                        <li>专业的学习进度追踪与评估系统</li>
                        <li>互动社区交流，与同学们共同进步</li>
                    </ul>
                </div>
        ...
        <div class="register-right">
            <div class="register-form-container">
                <h2>注册信息填写</h2>
                <p class="welcome-text">欢迎加入编程学习平台，请填写以下信息</p>

                <el-form ref="loginForm" :model="formData" :rules="rules" label-position="top" size="large">
                    ...
                    <el-form-item label="验证码" prop="Code">
                        <div class="verify-code-container">
                            <el-input v-model.trim="formData.Code" placeholder="请输入验证码"></el-input>
